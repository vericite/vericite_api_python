...
class ReportMetaData(object):
    ...
    """
    def __init__(self, user_first_name=None, user_last_name=None, user_email=None, user_role=None, assignment_title=None, context_title=None, external_content_data=None):
        """
